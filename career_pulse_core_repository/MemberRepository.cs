...
{
    public class MemberRepository<Member>
    {
        ...
        public ICollection<Member> RetrieveData(string procedureName, SqlParameter[] parameters = null)
        {
            ICollection<Member> data = new List<Member>();
                ...
                using (var sqlConnection = new SqlConnection(_connectionString))
                {
                    using (var sqlCommand = new SqlCommand(procedureName, sqlConnection))
                    {
                        try
                        {
                            ...
                            data = JsonConvert.DeserializeObject<ICollection<Member>>(jsonResult.ToString()) ?? new List<Member>();
                        }
                        catch (Exception)
                        {
