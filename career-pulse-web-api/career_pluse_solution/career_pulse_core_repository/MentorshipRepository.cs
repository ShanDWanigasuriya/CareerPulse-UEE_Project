...
{
    public class MentorshipRepository<Mentorship>
    {
        private string _connectionString;

        public MentorshipRepository(string connectionString)
        {
        ...
        public ICollection<Mentorship> RetrieveData(string procedureName, SqlParameter[] parameters = null)
        {
            ICollection<Mentorship> data = new List<Mentorship>();
                ...
                using (var sqlConnection = new SqlConnection(_connectionString))
                {
                    using (var sqlCommand = new SqlCommand(procedureName, sqlConnection))
                    {
                        try
                        {
                            ...
                            data = JsonConvert.DeserializeObject<ICollection<Mentorship>>(jsonResult.ToString()) ?? new List<Mentorship>();
                        }
                        catch (Exception)
                        {
                            return new List<Mentorship>();
                        }
                        finally
                        {
                            sqlConnection.Close();
