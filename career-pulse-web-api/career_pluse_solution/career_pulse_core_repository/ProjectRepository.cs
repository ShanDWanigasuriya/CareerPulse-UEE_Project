...
{
    public class ProjectRepository<Project>
    {
        ...
        public ICollection<Project> RetrieveData(string procedureName, SqlParameter[] parameters = null)
        {
            ICollection<Project> data = new List<Project>();
                ...
                using (var sqlConnection = new SqlConnection(_connectionString))
                {
                    using (var sqlCommand = new SqlCommand(procedureName, sqlConnection))
                    {
                        try
                        {
                            ...
                            data = JsonConvert.DeserializeObject<ICollection<Project>>(jsonResult.ToString()) ?? new List<Project>();
                        }
                        catch (Exception)
                        {
